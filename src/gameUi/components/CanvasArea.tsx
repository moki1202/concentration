...
import card_back from '../../assets/images/back_card.png'
import { AllCards } from '../data/cardData'
import watermark_path from '../../assets/images/watermark.png'
  ...
  useEffect(() => {
    const initialize_pixi = async () => {
      ...
      const front_textures = await Promise.all(
        _.map(AllCards, async (card_path) => {
      ...
      console.log('Card back texture loaded:', back_texture)
      ...
      _.forEach(front_textures, (front_texture) => {
